...
export default function FormBody({ state }: { state: FormState, sources: { id: string, label: string}[] }) {
    ...
    return (
      <div className="rounded-md bg-gray-50 p-6 shadow-sm">
          ...
          <div className="text-[12px] mb-5">
            <p className=" font-mono ">
              ...
              <span className="text-green-600">
                https://peerplay.space/play/{state.data.id}
              </span>
            </p>
        ...
        <div className="mt-6 flex justify-end gap-4">
          <Button type="submit">{pending ? 'Creating...' : 'Create PeerPlay'}</Button>
        </div>
      </div>
    );
  }